class GestionReparaciones:
    ...
    def obtener_puestos_de_reparacion(self):
        ''' Devuelve el número de puestos de reparación que hay en el taller '''
        return self.puestos_de_reparacion